<template>
    <div class="dropdown-like-grp" @click="SH_show_hide_me('drop_funil_v')" >
        <div class="drop-btn creme" >
            <label id="drop_funil_mini_label">Prospecção</label>
  ...
  data: function () {
    ...
    methods:{
        SH_show_hide_me: function(){
            ...
            var dropdow=document.getElementById('drop_funil_v');
        ...
        dropdown_load_funis: function(){
            ...
            .then((response) => {
                ...
                ///document.getElementById('drop_funil_v_label').innerHTML=response.data.rows[0].funil;
            })
            .catch(function (error) {
                alert('erro com mensagens : '+error);
            });
